...
function Sobre() {
  ...
  return (
    <>
      ...
      <section id="sobre-nos" className="container py-4 g-2">
        
        <div className="card">
          <div className="card-header">
            <h2>Sobre Nós</h2>
            <div className="avatar">
         <div className="overflow-hidden rounded" style={{ width: "96px" }}>
           <img src="https://img.daisyui.com/images/profile/demo/batperson@192.webp" alt="Avatar" className="img-fluid" />
             </div>
            </div>
          </div>
